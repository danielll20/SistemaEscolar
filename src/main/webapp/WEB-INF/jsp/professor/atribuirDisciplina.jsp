...
<div class="modal-dialog" role="document">
	<div class="modal-content">
		...
		<div class="modal-body">
			<form id="cadastrarAluno" action="${url}/professor/adicionaAtribuicaoDiscipina" method="post">					
				<div class="form-group">
					<label class="col-sm-2 control-label" for="disciplina" style="margin-left: -10px;">Disciplina:</label>
					<div class="col-sm-5"><br>
						<select class="selectBox" name='atribuicaoDisciplina.disciplina.id' id='disciplina.id' style="margin-left: -100px; width: 210px;">
							<option id="disciplina">Selecione uma Disciplina</option>
