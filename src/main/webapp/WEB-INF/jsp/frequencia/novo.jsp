...
<div class="panel panel-default">
	<div class="panel-heading">
		<h4>Frequência de Alunos</h4>  	 
	</div>
	<br>
	<div class="form-group">
		<form name="formFrequencia" action="${url}/frequencia/aluno/pesquisar" method="get">
...
<%-- 					</c:forEach> --%>
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input class="form-control" type="text" id="data" readonly="true"/>
				</div>
			</div>
